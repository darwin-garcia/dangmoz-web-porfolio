...
export default function AboutResume() {
  return (
    <div className="pt-2 pb-2">        
        ...
        <p className="pt-2">I am looking for opportunities to be part of an IT team in a company where I can grow professionally and contribute with my acquired skills.</p>
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center gap-7 p-7">
          <div className="flex flex-col min-h-64 bg-gray-100 dark:bg-blue-700/50 p-8 rounded-xl drop-shadow-xl text-center">
              ...
              <div className='mt-1 pb-2 pt-2'>
                <h3 className="text-blue-800 dark:text-blue-100 font-bold hover:text-cyan-600 duration-300">Experience</h3>
              </div>
            </div>  
            <div className='border-t-2'/>
            <p className="text-gray-500 pt-2 dark:text-gray-300">1 Year as Junior Data Scientist</p>
          </div>
          ...
          <div className="flex flex-col min-h-64 bg-gray-100 dark:bg-blue-700/50 p-8 rounded-xl drop-shadow-xl text-center ">
              ...
              <div className='mt-1 pt-2 pb-2'>
                <h3 className="text-blue-800 dark:text-blue-100 font-bold hover:text-cyan-600 duration-300">Reviews</h3>
              </div>
            </div>  
            <div className='border-t-2'/>
            <ul className="justify-center max-w-md pt-2 px-0 mx-0 list-none text-gray-500 dark:text-gray-300 min-w-full">
                <li>1 Successful </li>
                <li>Next Match in progress.</li>
            </ul>            
          </div>
