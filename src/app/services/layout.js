export const metadata = {
  ...
  description: "Here you can see my data business and solutions.",
        ...
        <section className='mb-auto pt-14'>
            <div className='divide-y'>
                <div className='space-y-2 pt-6 pb-8 md:space-y-5 py-4 px-4'>                  
                    ...
                    <p className='text-lg leading-7 text-gray-600 dark:text-gray-400 text-center'> Here you can see my data business and solutions.</p>
                </div>
            </div>
